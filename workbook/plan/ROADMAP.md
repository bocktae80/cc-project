...
- [x] 06 — Hooks (PreToolUse, PostToolUse) → [`06-hooks`](../../projects/06-hooks/)
- [x] 07 — MCP 서버 (MCP, 커스텀 서버) → [`07-mcp-server`](../../projects/07-mcp-server/)
- [x] 08 — Skills & 커맨드 (커스텀 스킬) → [`08-skills-commands`](../../projects/08-skills-commands/)

## Phase 4: 최신 기능 (v2.1.46~2.1.50)
